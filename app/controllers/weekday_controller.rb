class WeekdayController < ApplicationController
  ...
  def index
    ...
    @day = [t('app.controllers.weekday_controller.sunday'), t('app.controllers.weekday_controller.monday'), t('app.controllers.weekday_controller.tuesday'), t('app.controllers.weekday_controller.wednesday'), t('app.controllers.weekday_controller.thursday'), t('app.controllers.weekday_controller.friday'), t('app.controllers.weekday_controller.saturday')]
    @days = ["0", "1", "2", "3", "4", "5", "6"]
  end
