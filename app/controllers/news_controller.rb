class NewsController < ApplicationController
  ...
  def add
    ...
    if request.post? and @news.save
      ...
      flash[:notice] = t('app.controllers.news_controller.news_added')
  ...
  def delete
    ...
    flash[:notice] = t('app.controllers.news_controller.news_item_deleted_succefully')
  ...
  def edit
    ...
    if request.post? and @news.update_attributes(params[:news])
      flash[:notice] = t('app.controllers.news_controller.news_updated')
      redirect_to :controller => 'news', :action => 'view', :id => @news.id
    end
  end
