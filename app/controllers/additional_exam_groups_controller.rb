class AdditionalExamGroupsController < ApplicationController
  ...
  def create
    ...
    if @additional_exam_group.save
      ...
      flash[:notice] = t('app.controllers.additional_exam_groups_controller.additional_exam_group_successfuly_saved')
  ...
  def update
    ...
    if @additional_exam_group.update_attributes(params[:additional_exam_group])
      flash[:notice] = t('app.controllers.additional_exam_groups_controller.updated_additional_exam_group_successfully')
