class ExamsController < ApplicationController
  ...
  def create
    ...
    if @exam.save
      flash[:notice] = t('app.controllers.exams_controller.new_exam_created_successfully')
  ...
  def update
    ...
    if @exam.update_attributes(params[:exam])
      flash[:notice] = t('app.controllers.exams_controller.updated_exam_details_successfully')
  ...
  def save_scores
    ...
    flash[:notice] = t('app.controllers.exams_controller.exam_scores_updated')
    redirect_to [@exam_group, @exam]
  end
