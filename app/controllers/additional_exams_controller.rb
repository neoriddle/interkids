class AdditionalExamsController < ApplicationController
  ...
  def save_additional_scores
    ...
    flash[:notice] = t('app.controllers.additional_exams_controller.additional_exam_scores_updated')
  ...
  def create
    ...
    if @additional_exam.save
      flash[:notice] = t('app.controllers.additional_exams_controller.new_exam_created_successfully')
  ...
  def update
    ...
    if @additional_exam.update_attributes(params[:exam])
      flash[:notice] = t('app.controllers.additional_exams_controller.updated_additional_exam_details_successfully')
      redirect_to [@additional_exam_group, @additional_exam]
    else
      render 'edit'
    end
