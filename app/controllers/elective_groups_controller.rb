class ElectiveGroupsController < ApplicationController
  ...
  def create
    ...
    if @elective_group.save
      flash[:notice] = t('app.controllers.elective_groups_controller.new_elective_group_created')
  ...
  def destroy
    ...
    flash[:notice] = t('app.controllers.elective_groups_controller.deleted_elective_group')
    redirect_to batch_elective_groups_path(@batch)
  end
