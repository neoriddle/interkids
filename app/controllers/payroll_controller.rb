class PayrollController < ApplicationController
  ...
  def add_category
    ...
    if request.post? and @category.save
      flash[:notice]= t('app.controllers.payroll_controller.payroll_category_saved')
  ...
  def edit_category
    ...
    if request.post? and @category.update_attributes(params[:category])
      flash[:notice] = t('app.controllers.payroll_controller.payroll_category_updated')
      redirect_to :action => "add_category"
    end
  end
  ...
  def delete_category
    ...
    flash[:notice]= t('app.controllers.payroll_controller.successfully_deleted')
    redirect_to :action => "add_category"
    else
      flash[:notice]= t('app.controllers.payroll_controller.unable_to_delete')
      redirect_to :action => "add_category"
    end
  end
  ...
  def manage_payroll
    ...
    if request.post?
      ...
      flash[:notice] = t('app.controllers.payroll_controller.data_saved_for') + "#{@employee.first_name}"
